...
// BIP-340 verification for the relay; signing for tests and dev tools.
package secp256k1
...
// Opaque keypair (96 bytes), used to generate signed test and tool events.
Keypair :: struct {
	data: [96]u8,
}
...
// Used by tests, event generation, and benchmarks; the relay never signs.
